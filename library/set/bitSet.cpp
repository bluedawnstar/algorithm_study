...
static bool check(bitset<N>& bs1, BitSet& bs2) {
    for (int i = 0; i < N; i++)
...
static bool check(bitset<N>& bs1, BitSetSimple& bs2) {
    for (int i = 0; i < N; i++)
        if (bs1.test(i) != bs2.test(i))
            return false;
    return true;
...
static bool check(bitset<N>& bs1, BitSetVariable& bs2) {
    for (int i = 0; i < N; i++)
        if (bs1.test(i) != bs2.test(i))
            return false;
    return true;
...
static bool check(bitset<N>& bs1, BitSet64& bs2) {
    for (int i = 0; i < N; i++)
        if (bs1.test(i) != bs2.test(i))
            return false;
    return true;
...
static bool check(bitset<N>& bs1, BitSetSimple64& bs2) {
    for (int i = 0; i < N; i++)
        if (bs1.test(i) != bs2.test(i))
            return false;
    return true;
...
static bool check(bitset<N>& bs1, BitSetVariable64& bs2) {
    for (int i = 0; i < N; i++)
        if (bs1.test(i) != bs2.test(i))
            return false;
    return true;
