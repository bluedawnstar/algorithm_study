...
#include "mergeSortTreeCompact.h"
...
static void test(vector<int>& in, CompactMergeSortTree<int>& tree, int N, int L, int R, int K) {
...
void testMergeSortTreeCompact() {
    //return; //TODO: if you want to test, make this line a comment.

    cout << "--- Compact Merge Sort Tree ---------------------------------------" << endl;
    ...
    for (int i = 0; i < T; i++) {
        ...
        CompactMergeSortTree<int> tree(in);
        for (int j = 0; j < T; j++) {
            int K = RandInt32::get() % N;
